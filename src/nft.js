...
export default function NFT() {
  ...
  async function callApi() {
    ...
    return (
        <div className='nftApp nftportal mb-4'>
                      ...
                      <div className="card nft-card mt-3 mb-3" key={i} >
                        ...
                        <div className="card-caption col-12 p-0">
                          <div className="card-body">
                            <h5 className="mb-0">BITK2WATER Collection NFT #{nft.tokenId}</h5>
                            <h5 className="mb-0 mt-2">Status<p style={{ color: "#39FF14", fontWeight: "bold", textShadow: "1px 1px 2px #000000" }}>Listo para Staking</p></h5>
                      ...
                      return (
                        ...
                        <div className="card stakedcard mt-3 mb-3" key={i} >
                          ...
                          <div className="card-caption col-12 p-0">
                            <div className="card-body">
                              <h5 className="mb-0">BITK2WATER Collection NFT #{nft.tokenId}</h5>
                              <h5 className="mb-0 mt-2">Status<p style={{ color: "#15F4EE", fontWeight: "bold", textShadow: "1px 1px 2px #000000" }}>Actualmente en Staking</p></h5>
                              <div className="card-bottom d-flex justify-content-between">
                                <input key={i} type="hidden" id='stakeid' value={nft.tokenId} />
